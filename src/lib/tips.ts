...
export const tips: Tip[] = [
  {
    ...
    href: "/docs/input/quick-input#系统短语",
    cta: "系统短语",
  },
  {
    id: "chaizi-tooltip",
    text: "不确定这个字怎么拆？开启悬停提示里的「拆字反查」即可看字根。",
    href: "/docs/customize/appearance#候选项提示信息",
    cta: "拆字反查",
  },
  {
    id: "smart-symbol",
    text: "中英文标点切来切去？开启「智能符号模式」，同一标点连按两次即转英文。",
    href: "/docs/input/punctuation#智能符号同键连按替换",
    cta: "智能符号",
  },
  {
    id: "pair-jump",
    text: "习惯打完括号按 `Tab` 跳出？跳出键可以改成 `Tab` 或回车。",
    href: "/docs/input/punctuation#跳出配对与配对状态",
    cta: "符号配对",
  },
  {
    id: "primary-pinyin",
    text: "临时拼音也想用双拼？把「主拼音方案」换成你惯用的双拼即可。",
    href: "/docs/customize/schemas#主方案设置",
    cta: "主方案设置",
  },
  {
    id: "app-initial-mode",
    text: "想让终端/桌面默认是英文？右键菜单 →「应用独立配置」。",
    href: "/docs/customize/appearance#应用独立的初始输入状态",
    cta: "应用独立配置",
  },
  {
    id: "sponsor",
  ...
  },
  {
    ...
    href: "/docs/reference/hotkeys#功能热键",
    cta: "快捷键总表",
  },
  {
    id: "calc",
    text: "算个数还要开计算器？中文模式下打 `;1+2*3`，候选直接给出 `7`。",
    href: "/docs/input/quick-input#快捷输入模式",
    cta: "快捷输入",
  },
  {
    id: "zz-symbols",
    text: "想要 →、±、①、㎏ 这类符号？`zz` 加分类缩写，`zzjt` 出箭头。",
    href: "/docs/input/quick-input#zz-系列符号",
    cta: "符号速查",
  },
  {
    id: "pinyin-tooltip",
  ...
  },
  {
    ...
    href: "/docs/advanced/command-bar",
    cta: "命令直通车",
  },
  {
    id: "schema-hotkey",
    text: "在五笔和拼音之间来回切？给每个方案配一个直达热键，一步到位。",
    href: "/docs/customize/schemas#schema-hotkey",
    cta: "方案直达热键",
  },
  {
    id: "screenshot",
    text: "想给候选窗留个截图？按 `Ctrl + Shift + F11`，或右键菜单 →「高级」。",
    href: "/docs/customize/hotkeys#功能快捷键",
    cta: "界面截图",
  },
  {
    id: "mode-layout",
    text: "临时拼音、临时英文想要竖排候选？每个模式的布局都能单独设。",
    href: "/docs/input/temp-modes#候选窗布局",
    cta: "候选窗布局",
  },
  {
    id: "inline-code",
    text: "想快速切换嵌入编码模式？输入 `copm` 一键就能来回切。",
    href: "/docs/customize/appearance#编码显示方式",
    cta: "编码显示方式",
  },
  {
    id: "theme-style",
    text: "想固定用暗色主题？亮色、暗色、跟随系统三选一，右键菜单也能切。",
    href: "/docs/customize/appearance#主题",
    cta: "主题风格",
  },
  {
    id: "status-bubble",
    text: "不想每次切换都闪一下状态气泡？在设置里关掉「状态提示气泡」。",
    href: "/docs/customize/appearance#状态提示",
    cta: "状态提示",
  },
  {
    id: "add-word",
  ...
  },
  {
    ...
    href: "/docs/customize/appearance#工具栏",
    cta: "工具栏",
  },
];
